...
if($result = mysqli_query($link, $sql)){
    ...
    {
             echo "<div id = 'robot'>";
       echo " <img src='robot2.png' style='max-width:400px;'><br>";
          
       echo "<h2>Zadaj pytanie:";

        echo  "<form method='post'><input type='text' name='pytanie'><input class='btn-primary' type='submit' value='Zapytaj!'/></br></form></h2>";
        $odpowiedz = "";
